...
<img  href="#" src="Images/logo.png" class="nav-link dropdown-toggle img-fluid" height="100px"
                                    width="100px" id="dropdown01" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false"></img><br>
...
<img src="Images/creatividad.jpg" class="nav-link dropdown-toggle img-fluid" height="200px"
                                    width="300px" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false"></img>
</div>
<div align="right" class="container">
<img src="Images/logo.png" class="nav-link dropdown-toggle img-fluid" height="300px"
                                    width="300px" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false"></img><br>
</div>
