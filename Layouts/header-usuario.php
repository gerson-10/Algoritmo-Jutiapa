<div align="center" class="container">
  <img src="Images/logo.png" class="nav-link dropdown-toggle img-fluid" height="50px" width="150px" href="index.php" aria-haspopup="true" aria-expanded="false"></img>
...
<div class="navbar">
  ...
  <a href="lista.php"><i class="fa fa-users" aria-hidden="true"></i> Usuarios</a>
  <a href="informacion.php"><i class="fa fa-id-card" aria-hidden="true"></i> Informacion</a>
  <a href="cierre_session.php"><i class="fa fa-power-off" aria-hidden="true"></i> Cerrar Session</a>
</div>
<?php
