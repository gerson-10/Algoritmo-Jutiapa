...
<body>
	<?php
	$url = 'https://newsapi.org/v2/everything?q=bitcoin&apiKey=428ac4303f1c4dd9b0cf8feb460bd74c';
	...
	<div class="jumbotron">
		<h1>&emsp;Algoritmo Jutiapa | NEWS | 50,000 alrededor del mundo</h1>
	...
	<div class="container-fluid">
		...
		foreach ($NewsData->articles as $News)
			foreach ($NewsData->articles as $urls) {
		?>
			<div class="row NewsGrid">
				...
				<div class="col-md-9">
					...
					<p>Content: <?php echo $News->content ?> <p>
							...
							<h6>Pagina: <?php echo $News->url ?><img src="../Images/fondo5.png" align="right" style="max-width:8%;width:auto;height:auto;"></h6>
							<!--h6>Enlace<a href='<?php echo $News->url ?>'</a>Web </h6-->
				</div>
			</div>
		<?php
			}
