                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mt-3 mb-4">
                                    <li></li>
                                    <li>Code.org® es una organización sin fines de lucro dedicada a ampliar el acceso a las ciencias de la computación en las escuelas y aumentar la participación de las mujeres y las minorías.
                                    <li>
