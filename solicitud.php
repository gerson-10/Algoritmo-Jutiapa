    ...
    if ($nombre_archivo != "") {
        if(!file_exists($destino)){
            if (copy($ruta, $destino)) {
                ...
                $motivo= $_POST['MOTIVO'];
                $db=new Conect_MySql();
                $sql = "INSERT INTO tb_solicitud(CORREOINGRESA,NOMBREINGRESA,RUTAPDF,NOMBREARCHIVO,MOTIVO) VALUES('$correoi','$nombre_completo','$destino','$nombre_archivo','$motivo')";
    ...
    <div class="container">
        ...
        <form  class="form-horizontal validate-form" action="" enctype="multipart/form-data" method="post">
            ...
            <div class="wrap-input1 validate-input" data-validate = "Las Placas son requeridas">
                <input class="input1" type="text" name="MOTIVO" placeholder="Motivo de solicitud">
                <span class="shadow-input1"></span>
            </div><BR>
            <!--span class="contact1-form-title">
					Datos del Empleado
